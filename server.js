...
// Submit redemption - AUTHENTICATED (CHANGE THIS)
app.post('/api/redeem', isAuthenticated, async (req, res) => {
  ...
  try {
    ...
    // Store the message and priority data - for priority picks, combine them
...
// Admin: Get pending redemptions (CHANGE THIS)
app.get('/api/admin/pending', (req, res) => {
  ...
  // Return ALL redemptions, not just pending
